...
public class PropertyController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<PropertyListItemResponse> getPropertyById(@PathVariable Long id) {
    	PropertyListItemResponse property = propertyListService.getPropertyDetail(id);
